...
void Application::Start() {
	...
	m_radioBearer->GetSource()->GetProtocolStack()->GetRrcEntity()->AddRadioBearer(
			m_radioBearer);
	...
	m_radioBearer->GetDestination()->GetProtocolStack()->GetRrcEntity()->AddRadioBearerSink(
			m_bearerSink);
...
void Application::Print(void) {
	cout << " Application object: "
			"\n\t m_applicationType = " << m_applicationType << endl;
}
